...
public class NieuweTaakActivityTest {

    @Test
    public void naam_nieuweTaak_moet_False_Returnen_Wanneer_String_Leeg_Is() {
    ...
    @Test
    public void naam_nieuweTaak_moet_False_Returnen_Wanneer_String_niet_alleen_letters_bevat() {
    ...
    @Test
    public void omschrijving_nieuweTaak_moet_False_Returnen_Wanneer_String_Leeg_Is() {
    ...
    @Test
    public void omschrijving_nieuweTaak_moet_False_Returnen_Wanneer_String_niet_alleen_letters_bevat() {
